...
<div class="jsformWrapper">
    <form name="jsform" method="post"
        ...
        <div class="formFielWrapper">
            ...
            <input type="text" name="pp_TxnRefNo" id="pp_TxnRefNo" value="T20211024010244">
        </div>
        ...
        <input type="hidden" name="pp_TxnDateTime" value="20211024010244">
        <div class="formFielWrapper">
        ...
        <input type="hidden" name="pp_TxnExpiryDateTime" value="20211025010244">
